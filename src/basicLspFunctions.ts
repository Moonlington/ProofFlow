...
export class LSPMessenger {
  ...
  public static async initializeServer(filePath: string): Promise<void> {
    try {
      const response = await axios.get(
        "http://localhost:3000/initialize_server",
        {
          params: {
            filePath: filePath,
          },
  ...
  public static async references(
    uri: string,
    line: number,
    character: number,
  ): Promise<void> {
  ...
  public static async typeDefinition(
    uri: string,
    line: number,
    character: number,
  ): Promise<void> {
  ...
  public static async signatureHelp(
    uri: string,
    line: number,
    character: number,
  ): Promise<void> {
  ...
  public static async gotoDeclaration(
    uri: string,
    line: number,
    character: number,
  ): Promise<void> {
    try {
      const response = await axios.get(
        "http://localhost:3000/gotoDeclaration",
        {
          params: {
            uri: uri,
            line: line,
  ...
  //@ts-ignore
  public static async requestCompletion(
    uri: string,
