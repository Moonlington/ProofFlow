...
export const collapsibleContentType = ProofFlowSchema.nodes["collapsible_content"];
export const collapsibleTitleNodeType = ProofFlowSchema.nodes["collapsible_title"];
