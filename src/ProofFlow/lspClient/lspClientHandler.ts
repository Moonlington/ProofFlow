...
import { Position, ProofFlowDocument, Range } from "../editor/ProofFlowDocument.ts";
...
interface LSPClientHandler {
    // Lifecycle Messages
    initalize(): Promise<m.InitializeResult>
    initialized(): void
    shutdown(): void
    exit(): void
    ...
    completion(pos: Position): Promise<m.CompletionItem[] | m.CompletionList | null>
}